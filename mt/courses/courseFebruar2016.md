...
- missinglister - fra tekstene i texts/ - lag sjøl med denne [kommandoen](../infra//MissingList.html) - fra relevante tekster i hele korpuset (Trond lager) - prioriter substantiv-lister uten sammensetning, og verb- og adjektiv-lister uten derivasjon - kommando for å fornye missinglista (ordene som får analyse kan fjernes), eksempel fra smj: \\
