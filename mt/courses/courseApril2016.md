...
1. **tmx_data** : sihke sme ja smX seammá fiillas, okta cealkka háválassii.
   tmx-formáhtain lea vejolaš genereret html-fiilla.
1. **fi.samediggi** : sihke sme ja smn seammá fiillas, okta cealkka háválassii.
   tmx-formáhtain lea vejolaš genereret html-fiilla.
1. **pseudo_tmx_data** : dušše sme, okta cealkka háválassii.
   tmx-formáhtain lea vejolaš genereret html-fiilla.
1. **otpt_dir/** : output-directory mas leat fiillat mat leat genererejuvvon python-skriptain.
