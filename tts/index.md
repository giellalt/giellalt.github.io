...
The development and build status of the text processing (aka normalisation) modules for all TTS languages [can be seen on the overview page](TTSTextprocOverview.md).
