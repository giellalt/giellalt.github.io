...
This is an overview over the morphological tags used at the Giellatekno projects. Note that this list is a **static list** and may be outdated. The updated list you will find in the _Links to generated source file documentation_ under the presentation of each language in the [language overview](/LanguageModels.html).
