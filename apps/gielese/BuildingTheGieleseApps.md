...
1. Once successful... Select from the _Product_ menu: _Archive_
1. Once the archiving process completes, you will see a window with the latest archive
1. Select this, and choose _Submit_
...
_Problem_: Phonegap 3.5 seems to automatically include API calls to set up
...
_Gielese/Classes/AppDelegate.m_. Apple is warning that the certificate does
