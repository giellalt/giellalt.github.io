...
Чтобы искать более сложные выражения, используйте единственные или двойные кавычки. Команда **grep mii имя*файла**находит из текста на северосамском языке как *mii* так и *huksemiid*. Чтобы искать *mii* только в начале слов, Вы можете написать**grep ' mii' имя*файла**. Чтобы только искать целое слово _mii_, пользуйте флаг**-w**(**grep -w mii имя_файла**).
